  ...
  if (commandName === "recommend") {
    ...
    if (targetUser.bot) {
      return interaction.editReply({
        content: "You can't recommend media to a bot!",
        ephemeral: true,
      });
    }
    if (targetUser.id === recommendingUser.id) {
      return interaction.editReply({
        content: "You can't recommend media to yourself!",
        ephemeral: true,
      });
    }
    ...
    try {
      ...
      await interaction.editReply({
        content:
          "Oops! An internal bot error occurred after receiving the API response. Check console for details.",
        ephemeral: true,
      });
    }
  }
